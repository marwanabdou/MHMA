...
<div className="text-center mb-20 mt-5">
  ...
  <p className="mt-1 text-gray-600   ">The outcome of a project&apos;s success relies heavily on the forward-moving procedure it follows. A steady approach yields reliable outcomes, excellence, and the expansion of business. Although each project we undertake has its distinct result, we adhere to a uniform procedure to guarantee optimal outcomes. When collaborating with MHMA, we will guide you through every stage of your website development, explaining each phase as we advance.</p>

</div>

  <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-10">
    <a className="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg transition-all duration-300 rounded-xl p-5      " href="#">
