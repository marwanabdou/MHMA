  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
            <h1 className=" text-center mb-6 text-5xl lg:text-7xl  font-medium   text-white dark:text-white mb-15">Take your business to the next level</h1>
            <p className="mb-12  text-white dark:text-gray-400 text-2xl">Ready to Elevate Your Online Presence? Contact Us Today!</p>
